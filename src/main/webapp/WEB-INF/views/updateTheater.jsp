...
<html>
 ...
 -->
    ...
    <main>
      <!-- <form action="updateTheater" modelAttribute="th" method="post"></form> -->
      <sp:form action="/TheatreTable/updateTheater/${theater.theatreId}" method="post" modelAttribute="th">
        <sp:input type="hidden" path="theatreId" id="theatreId" value="${theater.theatreId}" />
        <table width="500px" style="margin: auto"><%--
						<tr>
							<td>Theater Id</td>
							<td>:
								<sp:input path="theatreId" value="${theater.theatreId}" />
							</td>
						</tr> --%> <tr>
            <td>Theater Name</td>
            <td>:
              <sp:input path="thatreName" value="${theater.thatreName}" />
            </td>
          </tr>
          ...
          <tr>
            <td>City</td>
            <td>:
              <sp:input path="city" value="${theater.city}" />
            </td>
          </tr>
        </table>
        <div class="text-center" style="margin-top: 20px;margin-top: 20px;">
